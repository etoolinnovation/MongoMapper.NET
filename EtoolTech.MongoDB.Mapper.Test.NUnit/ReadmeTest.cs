...
namespace EtoolTech.MongoDB.Mapper.Test.NUnit
{
    ...
    public class ReadmeTest
    {
        ...
        public void Test()
        {
            ...
            countries.MongoFind(Query.Or(MongoQuery.Eq((Country co) => co.Code, "ES"),
                                         MongoQuery.Eq((Country co) => co.Code, "UK")));
            ...
            p.ServerUpdate(Update.PushWrapped("Childs",
                                              new Child
                                                  {
                                                      ID = 2,
                                                      Age = 2,
                                                      BirthDate = DateTime.Now.AddDays(57).AddYears(-7),
                                                      Name = "Ana Perez"
                                                  }));
