    ...
    public class ConfigTest
    {
        ...
        public void TestReadConfig()
        {
            Assert.AreEqual(ConfigManager.GetConnectionString("XXX"),
                "mongodb://192.168.1.214:27017,192.168.1.216:27017/TestDotNET?replicaSet=devSet;w=2;slaveOk=true;maxpoolsize=50;waitQueueTimeout=1000ms;safe=true;fsync=true");
