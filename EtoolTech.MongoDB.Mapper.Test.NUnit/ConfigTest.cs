    ...
    public class ConfigTest
    {
        ...
        public void TestReadConfig()
        {
            ...
            Assert.AreEqual(ConfigManager.GetConnectionString("Person"),
                "mongodb://192.168.1.214:27017,192.168.1.216:27017/TestDotNETPerson?replicaSet=devSet;w=1;slaveOk=true;maxpoolsize=50;waitQueueTimeout=2000ms;safe=true;fsync=true");
