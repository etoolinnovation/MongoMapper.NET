...
namespace EtoolTech.MongoDB.Mapper.Test
{
    ...
    public class ConfigTest
    {
        ...
        public void TestReadConfig()
        {
			...
			Assert.AreEqual(ConfigManager.GetConnectionString("Fake"), "mongodb://user:pass@fake.com:27017/Test?connect=direct;maxpoolsize=10;waitQueueTimeout=2000ms;safe=true;fsync=true");			
        }
    }
}
